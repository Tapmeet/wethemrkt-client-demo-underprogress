            ...
            <Row>
              ...
              <Col lg="4" sm="6" className="align-self-center">
                <div>
                  ...
                  <h5>
                    +4.5701 % UP {" "} <br/>
                    <span className="text-muted font-size-14">$ 114.10 USD</span>
                  </h5>
                </div>
                ...
                <div className="mt-4 pt-2">
                  ...
                  <h5>
                    +12.98 % UP {" "} <br/>
                    <span className="text-muted font-size-14">$ 2729.58</span>
                  </h5>
                </div>
                ...
                <div className="mt-4 pt-2">
                  ...
                  <h5>
                    +2.20 % UP {" "} <br/>
                    <span className="text-muted font-size-14">$ 285.27</span>
                  </h5>
                </div>
              </Col>
            </Row>
