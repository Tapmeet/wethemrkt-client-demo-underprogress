	...
	const followUser = userId => {
		axiosAuthHttpMiddelware
			...
			.then(response => {
				...
				// getUserPostList(filterTag, filterTime, filterUser, filterWhat).then()
			})
			.catch(err => {
		...
		<div key={key} className="ct-postbox">
			...
			<div className="userpost-box">
				<div className="arrow-box">
					...
					{showVote && (
						<div className="short-arw-box">{addedVote(element.votes, key)}</div>
					)}
						...
						<>
							{isJsonString(element.imagedata) ? (
								<div className="row">
												...
												<div
													...
													<div className="details-imagebox d-flex justify-content-center bg-black">
														<img
															...
															alt=""
															onClick={() =>
																showModalImage(element.imagedata, key)
															}
														/>
													</div>
												</div>
									...
									{element.linkid > 0 && (
										<div className="col-6">
											<div className="details-imagebox" style={{ overflow: "scroll" }}>
